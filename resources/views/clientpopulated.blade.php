        ...
        <div class="main">
                    ...
                    <div class="table">
                              ...
                              @foreach($clients as $client)
                                    ...
                                    <div class="table-cell-2"><div class="value">{{$client->Name}}</div></div>

                                    <div class="table-cell-3">
                                      <div class="tag">
                                        <div class="div-wrapper"><div class="label-3">{{$client->Status}}</div></div>
                                      </div>
                                    </div>
                        
                                    <div class="table-cell-4"><div class="value-2">{{$client->Created}}</div></div>

                                    <div class="table-cell-4"><div class="value-2">{{$client->Tasks}}</div></div>

                                    <div class="table-cell-4"><div class="value-2">{{$client->Contributers}}</div></div>

                                    <div class="table-cell-4"><div class="value-2">{{$client->Budget}}</div></div>
